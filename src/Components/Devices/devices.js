              ...
              <div class="card-body"> 
                ...
                <table class="table table-hover">
                  ...
                  <tr>
                      ...
                      <td class="text-truncate"><a href="devices-overview.html" class="entity-popup text-nowrap trigger" data-eid="1" data-etype="device"><strong>{basicListData.hostname}</strong></a></td>
                      <td class="text-truncate">{basicListData.hardware}</td>
                      <td class="text-truncate">{basicListData.os}</td>
                      <td class="text-truncate">{basicListData.uptime}</td>
                    </tr> 
