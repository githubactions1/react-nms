                ...
                >
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        {" "}
                        <a href="devices.html" className="dropdown-item">
                        ...
                        <a href="severs.html" className="dropdown-item">
                          <i className="mdi mdi-server-network"></i> Severs{" "}
                          <span className="badge badge-pill badge-success">
                            2
                          </span>
                        </a>{" "}
                        <a href="network.html" className="dropdown-item">
                        ...
                        <a href="down.html" className="dropdown-item">
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        {" "}
                        <a href="ports.html" className="dropdown-item">
                          <i className="fas fa-desktop"></i> All Ports{" "}
                          <span className="badge badge-pill badge-danger">
                            37
                          </span>
                        </a>{" "}
                        <a href="vlans.html" className="dropdown-item">
                          <i className="feather-cpu"></i> VLANs
                        </a>{" "}
                        <a href="neighbours.html" className="dropdown-item">
                        ...
                        <a href="transit.html" className="dropdown-item">
                          <i className="feather-package"></i> Transit{" "}
                        </a>{" "}
                        <a href="peering.html" className="dropdown-item">
                          <i className="feather-target"></i> Peering{" "}
                        </a>{" "}
                        <a
                          href="peering-transit.html"
                          className="dropdown-item"
                        >
                        ...
                        <div className="dropdown">
                          ...
                          >
                            ...
                            <a href="up.html" className="dropdown-item">
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        {" "}
                        <a href="processors.html" className="dropdown-item">
                          Processors
                        </a>{" "}
                        <a href="memory.html" className="dropdown-item">
                          Memory
                        </a>{" "}
                        <a href="storage.html" className="dropdown-item">
                          Storage
                        </a>{" "}
                        <a href="status.html" className="dropdown-item">
                          Status
                        </a>{" "}
                        <a href="temperature.html" className="dropdown-item">
                          Temperature
                        </a>{" "}
                        <a href="fanspeed.html" className="dropdown-item">
                          Fanspeed
                        </a>{" "}
                        <a href="current.html" className="dropdown-item">
                          Current
                        </a>{" "}
                        <a href="voltage.html" className="dropdown-item">
                          Voltage
                        </a>{" "}
                        <a href="power.html" className="dropdown-item">
                          Power
                        </a>{" "}
                        <a href="frequency.html" className="dropdown-item">
                          Frequency
                        </a>{" "}
                      </div>
                    </li>
                    ...
                    <div className="col-lg-2">
                      <div className="form-group mt-2">
                        ...
                        <button
                          ...
                          name="search"
                          type="button"
                          className="btn btn-light pull-right text-nowrap"
                          onClick=""
                          value=""
                        >
                    ...
                    <div className="card-body">
                      <nav className="navbar navbar-expand-lg navbar-dark bg-transparent">
                        ...
                        <div className="collapse navbar-collapse" id="main_nav">
                          <ul className="navbar-nav">
                            <li className="nav-item">
                              <a className="nav-link" href="devices-basic.html">
                                {" "}
                                Basic{" "}
                              </a>{" "}
                            </li>
                            ...
                            <li className="nav-item">
                              <a
                                className="nav-link"
                                href="devices-pollig-performance.html"
                              >
                                {" "}
                                Pollig Performance{" "}
                              </a>
                      ...
                      <table className="table table-hover">
                        <thead>
                          <tr className="text-truncate">
                            ...
                            <th className="border-top-0">
                              <a href=" ">Device</a> / <a href=" ">Location</a>
                            </th>
                            <th className="border-top-0"></th>
                            <th className="border-top-0"></th>
                            <th className="border-top-0"></th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <i className="fab fa-accusoft font-size-22"></i>
                            </td>
                            <td>
                              <a
                                href=" "
                          ...
                          <tr className="error">
                            ...
                            <td className="text-truncate">
                              <i className="fab fa-redhat font-size-22 text-danger"></i>
                            </td>
                            <td className="text-truncate">
                              <a
                                href=" "
