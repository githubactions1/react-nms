                ...
                <nav className="navbar navbar-expand-lg navbar-dark bg-transparent"> <a className="navbar-brand" href=" ">Devices</a>
                  ...
                  <div className="collapse navbar-collapse" id="main_nav">
                    <ul className="navbar-nav">
                      ...
                      <li className="nav-item active"><a className="nav-link" href="devices-status.html"> Status </a></li>
                ...
                <table className="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a href=" " className="entity-popup text-nowrap trigger" data-eid="1" data-etype="device">Device Uptime</a></td>
                      <td><a href=" " className="entity-popup text-nowrap trigger" data-eid="1" data-etype="device">Memory Usage</a></td>
                      <td><a href=" " className="entity-popup text-nowrap trigger" data-eid="1" data-etype="device">Processors</a></td>
                      <td><a href=" " className="entity-popup text-nowrap trigger" data-eid="1" data-etype="device">Traffic</a></td>
                    </tr>
                    <tr>
                      <td className="blue"></td>
                      <td><i className="fab fa-accusoft font-size-22"></i></td>
